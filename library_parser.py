...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .delisted-warning { background: rgba(255, 68, 68, 0.15); border: 1px solid #ff4444; border-radius: 8px; padding: 12px; margin-bottom: 20px; color: #ff8888; font-size: 0.8rem; line-height: 1.4; display: none; }
        .delisted-warning b { color: #fff; display: block; margin-bottom: 4px; }
...
HTML_PART_2 = """<li id="filterNotice"></li></ul></div>
    ...
    <script>
        const translations = {
            ...
            ko: { warnDelisted: "<b>⚠️ 판매 중지된 콘텐츠</b>이 에셋은 Booth에서 더 이상 제공되지 않을 가능성이 높습니다. 메타데이터 지원이 제한적입니다.", navTitle: "Booth 에셋 라이브러리", optionsBtn: "설정 ⚙", labelLanguage: "언어", labelSort: "정렬", optId: "ID", optNew: "최근 추가됨", optName: "이름순", optRel: "관련성", optSize: "용량", labelAdult: "성인 필터", optAll: "모두 표시", optHide: "성인 숨기기", optOnly: "성인 전용", labelWidth: "너비", labelVisual: "표시", optBlur: "블러 해제", optHideIds: "ID 숨기기", optTranslate: "번역 제목 사용", labelBinary: "파일", footBooth: "🛒 Booth 보기", footFolder: "📂 폴더 열기", searchPre: "검색: ", searchSuf: "개", fileSingular: "파일", filePlural: "파일", moreTags: "+ {n}개 더보기", hiddenResults: " (+{n}개 숨김)" },
            ...
            pt: { warnDelisted: "<b>⚠️ Conteúdo não listado</b>Este asset provavelmente não está mais disponível no Booth. O suporte de metadados é limitado.", navTitle: "Biblioteca Booth", optionsBtn: "Opções ⚙", labelLanguage: "Idioma", labelSort: "Ordenar", optId: "ID", optNew: "Mais recentes", optName: "Nome", optRel: "Relevância", optSize: "Tamanho", labelAdult: "Filtro adulto", optAll: "Tudo", optHide: "Ocultar adultos", optOnly: "Apenas 18+", labelWidth: "Largura", labelVisual: "Visual", optBlur: "Sem flou", optHideIds: "Sem IDs", optTranslate: "Títulos inglês", labelBinary: "Arquivos", footBooth: "🛒 Booth", footFolder: "📂 Pasta", searchPre: "Pesquisar ", searchSuf: " itens...", fileSingular: "arquivo", filePlural: "arquivos", moreTags: "+ {n} mais", hiddenResults: " (+{n} ocultos)" }
        };
        ...
        function updateLanguage(lang) { 
            ...
            document.querySelectorAll('[data-i18n-html]').forEach(el => { el.innerHTML = t[el.dataset.i18n_html] || t[el.dataset.i18nHtml]; });
            applyFilters(); 
        }
