...
HTML_PART_2 = """<li id="filterNotice"></li></ul></div>
    ...
    <script>
        ...
        // Higher rootMargin to preload items 1000px before they enter view
        ...
        const observer = new IntersectionObserver((entries) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    // Stop observing once loaded to prevent jitter when scrolling back up
